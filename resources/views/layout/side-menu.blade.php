...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>OrderSkuy &mdash; Booking hangout place online</title>
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<h1 id="fh5co-logo"><a href="index.html"><img src="images/logoBlack.png" alt="orderSkuy"></a></h1>
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					<li><a href="index.html">Home</a></li>
					<li><a href="blog.html">Data order</a></li>
